describe Forest::TreePattern::VariableMatcher do
  before :each do
    @pb = Forest::TreePattern::PatternBuilder.new
    @vm = Forest::TreePattern::VariableMatcher.new(@pb, :var_name)
  end
  ...
  it "returns a TypeMatcher based on self" do
    tm = @vm.with_type(Forest::Types::Int)
    tm.node_pattern.should == @vm
    tm.type_pattern.should == Forest::Types::Int
  end
end
